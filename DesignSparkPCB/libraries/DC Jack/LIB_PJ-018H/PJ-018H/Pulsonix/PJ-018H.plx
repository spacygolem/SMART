...
(library Library_1
	...
	(patternDef "PJ018H" (originalName "PJ018H")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -4.982, -0.657) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -11.24 2.5) (pt 0.16 2.5) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0.16 2.5) (pt 0.16 -2.5) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0.16 -2.5) (pt -11.24 -2.5) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -11.24 -2.5) (pt -11.24 2.5) (width 0.025))
		)
	...
	(compDef "PJ-018H" (originalName "PJ-018H") (compHeader (numPins 3) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.cui.com/product/resource/pj-018h-smt-tr.pdf")
		(attr "<Component Height>" "5")
		(attr "<STEP Filename>" "PJ-018H.stp")
