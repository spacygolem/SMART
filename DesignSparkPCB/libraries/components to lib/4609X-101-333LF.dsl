SamacSys ECAD Model
389030/21746/2.16/9/4/Resistor Network
...
(library Library_1
	...
	(symbolDef "4609X-101-333LF" (originalName "4609X-101-333LF")
	...
	(compDef "4609X-101-333LF" (originalName "4609X-101-333LF") (compHeader (numPins 9) (numParts 1) (refDesPrefix RN)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "4609X-101-333LF"))
		...
		(attr "RS Part Number" "5224251")
		(attr "Manufacturer_Name" "Bourns")
		(attr "Manufacturer_Part_Number" "4609X-101-333LF")
		(attr "Allied_Number" "")
		(attr "Other Part Number" "")
		(attr "Description" "Bourns Bussed Resistor Network 33k 2% 8 Resistors, 1.13W Total, SIP Package 4600X Through Hole")
